...
model_gs = changeRxnBounds(model_gs,'DM_cpd00023',2,'l');
...
model_wt = changeRxnBounds(model_wt,optionalCarbon,0,'b');
model_gs = changeRxnBounds(model_gs,optionalCarbon,0,'b');
...
[carbon_mal_gs,minO2_mal_gs,nit_mal_gs] = getMinO2(model_gs,'EX_cpd00130',...
    fluxBounds_mal,fluxBounds_o2)
[carbon_mal_wt,minO2_mal_wt,nit_mal_wt] = getMinO2_nitFixed(model_wt,'EX_cpd00130',...
    fluxBounds_mal,fluxBounds_o2,nit_mal_gs) 

 
%Initialize wild-type and ammonia assimilating model with sucrose as a
%carbon source
model_sucr = model;
model_sucr = changeRxnBounds(model_sucr,optionalCarbon,0,'b');
model_sucr = changeRxnBounds(model_sucr,'EX_cpd00130',0,'b');

%For ammonia assimilation: minimum demand for glutamate
model_sucr_gs = model_sucr;
model_sucr_gs = changeRxnBounds(model_sucr_gs,'DM_cpd00023',2,'l');
